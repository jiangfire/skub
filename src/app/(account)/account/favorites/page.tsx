  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className="mb-6 flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-900">我的收藏</span>
      </div>

      <h1 className="mb-6 text-2xl font-bold text-gray-900">我的收藏 ({skills.length})</h1>

      {skills.length === 0 ? (
        <div className="rounded-lg border border-gray-200 bg-white p-8 text-center">
          <p className="text-sm text-gray-500">暂无收藏的技能</p>
          <Link
            href="/skills"
